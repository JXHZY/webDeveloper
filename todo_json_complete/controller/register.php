...
session_start();
$validationResult = validate_registration_form($_POST);         //In registration_service.php => check input values
...
else 
{
    ...
    $userNameAvailable = verify_username_availability($userName);       //In data_service.php => check user already exists or not
    ...
    //after check, add the new user into the data
